...
export default {
  ...
  data() {
    return {
      ...
      // 添加队列位置标识数据
      queueMarkers: [
        { id: 1, name: '预热1', queueId: 1, x: 1210, y: 630 },
        { id: 2, name: '灭菌1', queueId: 2, x: 1210, y: 300 },
        { id: 3, name: '预热2', queueId: 3, x: 1135, y: 630 },
        { id: 4, name: '灭菌2', queueId: 4, x: 1135, y: 300 },
        { id: 5, name: '预热3', queueId: 5, x: 1065, y: 630 },
        { id: 6, name: '灭菌3', queueId: 6, x: 1065, y: 300 },
        { id: 7, name: '预热4', queueId: 7, x: 990, y: 630 },
        { id: 8, name: '灭菌4', queueId: 8, x: 990, y: 300 },
        { id: 9, name: '预热5', queueId: 9, x: 915, y: 630 },
        { id: 10, name: '灭菌5', queueId: 10, x: 915, y: 300 },
        { id: 11, name: '预热6', queueId: 11, x: 842, y: 630 },
        { id: 12, name: '灭菌6', queueId: 12, x: 842, y: 300 },
        { id: 13, name: '预热7', queueId: 13, x: 767, y: 630 },
        { id: 14, name: '灭菌7', queueId: 14, x: 767, y: 300 },
        { id: 15, name: '预热8', queueId: 15, x: 692, y: 630 },
        { id: 16, name: '灭菌8', queueId: 16, x: 692, y: 300 },
        { id: 17, name: '预热9', queueId: 17, x: 620, y: 630 },
        { id: 18, name: '灭菌9', queueId: 18, x: 620, y: 300 },
        { id: 19, name: '预热10', queueId: 19, x: 545, y: 630 },
        { id: 20, name: '灭菌10', queueId: 20, x: 545, y: 300 },
        { id: 21, name: '预热11', queueId: 21, x: 470, y: 630 },
        { id: 22, name: '灭菌11', queueId: 22, x: 470, y: 300 },
        { id: 23, name: '预热12', queueId: 23, x: 395, y: 630 },
        { id: 24, name: '灭菌12', queueId: 24, x: 395, y: 300 },
        { id: 25, name: '预热13', queueId: 25, x: 320, y: 630 },
        { id: 26, name: '灭菌13', queueId: 26, x: 320, y: 300 },
        { id: 27, name: '预热14', queueId: 27, x: 245, y: 630 },
        { id: 28, name: '灭菌14', queueId: 28, x: 245, y: 300 },
        { id: 29, name: '预热15', queueId: 29, x: 170, y: 630 },
        { id: 30, name: '灭菌15', queueId: 30, x: 170, y: 300 }
      ],
