  ...
  data() {
    return {
      ...
      runningLogs: [
        {
          id: 1001,
          message: '系统启动完成，所有设备初始化成功',
          type: 'running',
          timestamp: new Date(Date.now() - 300000).getTime(), // 5分钟前
          unread: false
        },
        {
          id: 1002,
          message:
            '托盘 TP3201-001 已添加到 Y3201 队列，批次号：BATCH-3201-001，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 280000).getTime(), // 4分40秒前
          unread: false
        },
        {
          id: 1003,
          message:
            '托盘 TP3202-001 已添加到 Y3202 队列，批次号：BATCH-3202-001，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 260000).getTime(), // 4分20秒前
          unread: false
        },
        {
          id: 1004,
          message:
            '托盘 TP3205-001 已添加到 Y3205 队列，批次号：BATCH-3205-001，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 240000).getTime(), // 4分钟前
          unread: false
        },
        {
          id: 1005,
          message:
            '托盘 TP3207-001 已添加到 Y3207 队列，批次号：BATCH-3207-001，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 220000).getTime(), // 3分40秒前
          unread: false
        },
        {
          id: 1006,
          message: 'PLC连接状态正常，数据同步完成',
          type: 'running',
          timestamp: new Date(Date.now() - 200000).getTime(), // 3分20秒前
          unread: false
        },
        {
          id: 1007,
          message:
            '托盘 TP3201-002 已添加到 Y3201 队列，批次号：BATCH-3201-002，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 180000).getTime(), // 3分钟前
          unread: false
        },
        {
          id: 1008,
          message:
            '托盘 TP3202-002 已添加到 Y3202 队列，批次号：BATCH-3202-002，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 160000).getTime(), // 2分40秒前
          unread: false
        },
        {
          id: 1009,
          message:
            '托盘 TP3205-002 已添加到 Y3205 队列，批次号：BATCH-3205-002，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 140000).getTime(), // 2分20秒前
          unread: false
        },
        {
          id: 1010,
          message:
            '托盘 TP3207-002 已添加到 Y3207 队列，批次号：BATCH-3207-002，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 120000).getTime(), // 2分钟前
          unread: false
        },
        {
          id: 1011,
          message: '队列 Y3201 数据已更新',
          type: 'running',
          timestamp: new Date(Date.now() - 100000).getTime(), // 1分40秒前
          unread: false
        },
        {
          id: 1012,
          message: '队列 Y3202 数据已更新',
          type: 'running',
          timestamp: new Date(Date.now() - 80000).getTime(), // 1分20秒前
          unread: false
        },
        {
          id: 1013,
          message:
            '托盘 TP3201-003 已添加到 Y3201 队列，批次号：BATCH-3201-003，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 60000).getTime(), // 1分钟前
          unread: false
        },
        {
          id: 1014,
          message:
            '托盘 TP3205-003 已添加到 Y3205 队列，批次号：BATCH-3205-003，灭菌',
          type: 'running',
          timestamp: new Date(Date.now() - 40000).getTime(), // 40秒前
          unread: false
        },
        {
          id: 1015,
          message: '系统运行状态正常，所有队列工作正常',
          type: 'running',
          timestamp: new Date(Date.now() - 20000).getTime(), // 20秒前
          unread: false
        }
      ],
      alarmLogs: [
        {
          id: 2001,
          message: 'PLC通信异常，正在尝试重新连接',
          type: 'alarm',
          timestamp: new Date(Date.now() - 450000).getTime(), // 7分30秒前
          unread: true
        },
        {
          id: 2002,
          message: '队列 Y3201 托盘数量超过上限，请及时处理',
          type: 'alarm',
          timestamp: new Date(Date.now() - 380000).getTime(), // 6分20秒前
          unread: true
        },
        {
          id: 2003,
          message: '托盘 TP3202-001 灭菌状态异常，请检查',
          type: 'alarm',
          timestamp: new Date(Date.now() - 320000).getTime(), // 5分20秒前
          unread: false
        },
        {
          id: 2004,
          message: '系统温度传感器报警，当前温度：85°C',
          type: 'alarm',
          timestamp: new Date(Date.now() - 280000).getTime(), // 4分40秒前
          unread: false
        },
        {
          ...
          message: 'PLC连接已恢复正常',
          type: 'alarm',
          timestamp: new Date(Date.now() - 250000).getTime(), // 4分10秒前
          unread: false
        }
      ],
      ...
      queues: [
        ...
        },
        {
          ...
          trayInfo: [
            {
              trayCode: 'TP3201-001',
              trayTime: '2024-01-15 08:15:00',
              batchId: 'BATCH-3201-001',
              isTerile: 1,
              state: '0',
              sendTo: '',
              sequenceNumber: 1,
              orderId: 'ORD-3201-001',
              productCode: '01.01.30.0003',
              productName: '一次性使用避光静脉输液针',
              unit: '0.55×17.5RWLB',
              easModel: 'B-0.55',
            ...
            {
              trayCode: 'TP3201-002',
              trayTime: '2024-01-15 09:00:00',
              batchId: 'BATCH-3201-002',
              isTerile: 1,
              state: '0',
              sendTo: '',
              sequenceNumber: 2,
              orderId: 'ORD-3201-002',
              productCode: '01.01.30.0004',
              productName: '一次性使用避光静脉输液针',
              unit: '0.55×17.5RWLB',
              easModel: 'B-0.55(Y)',
              packageQuantity: 1000,
            ...
            {
              trayCode: 'TP3201-003',
              trayTime: '2024-01-15 09:45:00',
              batchId: 'BATCH-3201-003',
              isTerile: 1,
              state: '0',
              sendTo: '',
              sequenceNumber: 3,
              orderId: 'ORD-3201-003',
              productCode: '01.01.30.0005',
              productName: '一次性使用避光静脉输液针',
              unit: '0.6×22.5TWLB',
              easModel: 'B-0.6',
              packageQuantity: 1000,
            ...
            },
            {
              ...
              batchId: 'BATCH-3201-004',
              isTerile: 1,
              state: '0',
              sendTo: '',
              sequenceNumber: 4,
              orderId: 'ORD-3201-004',
              productCode: '01.01.30.0006',
              productName: '一次性使用避光静脉输液针',
              unit: '0.6×22.5TWLB',
              easModel: 'B-0.6(Y)',
              packageQuantity: 1000,
            ...
            },
            {
              ...
              batchId: 'BATCH-3201-005',
              isTerile: 1,
              state: '0',
              sendTo: '',
              sequenceNumber: 5,
              orderId: 'ORD-3201-005',
              productCode: '01.01.30.0007',
              productName: '一次性使用避光静脉输液针',
              unit: '0.7×22.5TWLB',
              easModel: 'B-0.7',
              packageQuantity: 1000,
