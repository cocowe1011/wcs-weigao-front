    ...
    .then((res) => {
      ...
      conn.initiateConnection(
        ...
        (err) => {
          ...
          // --- 23b. 预热/灭菌柜门开关到位 (DBW1560-DBW1574) ---
          conn.addItems('DBW1560'); // 预热进门开到位 BIT0~14: 3201~3215
          conn.addItems('DBW1562'); // 预热进门关到位 BIT0~14: 3201~3215
          conn.addItems('DBW1564'); // 预热出门开到位 BIT0~14: 3201~3215
          conn.addItems('DBW1566'); // 预热出门关到位 BIT0~14: 3201~3215
          conn.addItems('DBW1568'); // 灭菌进门开到位 BIT0~14: 3201~3215
          conn.addItems('DBW1570'); // 灭菌进门关到位 BIT0~14: 3201~3215
          conn.addItems('DBW1572'); // 灭菌出门开到位 BIT0~14: 3201~3215
          conn.addItems('DBW1574'); // 灭菌出门关到位 BIT0~14: 3201~3215
...
var variables = {
  ...
  DBW1560: 'DB1000,INT1560', // 预热进门开到位 BIT0~14: 3201~3215
  DBW1562: 'DB1000,INT1562', // 预热进门关到位 BIT0~14: 3201~3215
  DBW1564: 'DB1000,INT1564', // 预热出门开到位 BIT0~14: 3201~3215
  DBW1566: 'DB1000,INT1566', // 预热出门关到位 BIT0~14: 3201~3215
  DBW1568: 'DB1000,INT1568', // 灭菌进门开到位 BIT0~14: 3201~3215
  DBW1570: 'DB1000,INT1570', // 灭菌进门关到位 BIT0~14: 3201~3215
  DBW1572: 'DB1000,INT1572', // 灭菌出门开到位 BIT0~14: 3201~3215
  DBW1574: 'DB1000,INT1574', // 灭菌出门关到位 BIT0~14: 3201~3215
  ...
  W_DBW18_BIT0: 'DB1001,X18.0', // 3201预热出货
  W_DBW18_BIT1: 'DB1001,X18.1', // 3202预热出货
  W_DBW18_BIT2: 'DB1001,X18.2', // 3203预热出货
  W_DBW18_BIT3: 'DB1001,X18.3', // 3204预热出货
  W_DBW18_BIT4: 'DB1001,X18.4', // 3205预热出货
  W_DBW18_BIT5: 'DB1001,X18.5', // 3206预热出货
  W_DBW18_BIT6: 'DB1001,X18.6', // 3207预热出货
  W_DBW18_BIT7: 'DB1001,X18.7', // 3208预热出货
  W_DBW18_BIT8: 'DB1001,X19.0', // 3209预热出货
  W_DBW18_BIT9: 'DB1001,X19.1', // 3210预热出货
  W_DBW18_BIT10: 'DB1001,X19.2', // 3211预热出货
  W_DBW18_BIT11: 'DB1001,X19.3', // 3212预热出货
  W_DBW18_BIT12: 'DB1001,X19.4', // 3213预热出货
  W_DBW18_BIT13: 'DB1001,X19.5', // 3214预热出货
  W_DBW18_BIT14: 'DB1001,X19.6', // 3215预热出货
  ...
  W_DBW182: 'DB1001,INT182', // 1006异常处理完成
  W_DBW184: 'DB1001,INT184', // 复位信号

  // WCS执行进货灭菌柜出货命令 (DB1001.DBW186)
  W_DBW186_BIT0: 'DB1001,X186.0', // 3201灭菌出货
  W_DBW186_BIT1: 'DB1001,X186.1', // 3202灭菌出货
  W_DBW186_BIT2: 'DB1001,X186.2', // 3203灭菌出货
  W_DBW186_BIT3: 'DB1001,X186.3', // 3204灭菌出货
  W_DBW186_BIT4: 'DB1001,X186.4', // 3205灭菌出货
  W_DBW186_BIT5: 'DB1001,X186.5', // 3206灭菌出货
  W_DBW186_BIT6: 'DB1001,X186.6', // 3207灭菌出货
  W_DBW186_BIT7: 'DB1001,X186.7', // 3208灭菌出货
  W_DBW186_BIT8: 'DB1001,X187.0', // 3209灭菌出货
  W_DBW186_BIT9: 'DB1001,X187.1', // 3210灭菌出货
  W_DBW186_BIT10: 'DB1001,X187.2', // 3211灭菌出货
  W_DBW186_BIT11: 'DB1001,X187.3', // 3212灭菌出货
  W_DBW186_BIT12: 'DB1001,X187.4', // 3213灭菌出货
  W_DBW186_BIT13: 'DB1001,X187.5', // 3214灭菌出货
  W_DBW186_BIT14: 'DB1001,X187.6', // 3215灭菌出货
  W_DBW186_BIT15: 'DB1001,X187.7', // 备用

  // WCS执行进货预热柜允许进货命令 (DB1001.DBW188)
  W_DBW188_BIT0: 'DB1001,X188.0', // 3201预热进货
  W_DBW188_BIT1: 'DB1001,X188.1', // 3202预热进货
  W_DBW188_BIT2: 'DB1001,X188.2', // 3203预热进货
  W_DBW188_BIT3: 'DB1001,X188.3', // 3204预热进货
  W_DBW188_BIT4: 'DB1001,X188.4', // 3205预热进货
  W_DBW188_BIT5: 'DB1001,X188.5', // 3206预热进货
  W_DBW188_BIT6: 'DB1001,X188.6', // 3207预热进货
  W_DBW188_BIT7: 'DB1001,X188.7', // 3208预热进货
  W_DBW188_BIT8: 'DB1001,X189.0', // 3209预热进货
  W_DBW188_BIT9: 'DB1001,X189.1', // 3210预热进货
  W_DBW188_BIT10: 'DB1001,X189.2', // 3211预热进货
  W_DBW188_BIT11: 'DB1001,X189.3', // 3212预热进货
  W_DBW188_BIT12: 'DB1001,X189.4', // 3213预热进货
  W_DBW188_BIT13: 'DB1001,X189.5', // 3214预热进货
  W_DBW188_BIT14: 'DB1001,X189.6', // 3215预热进货
  W_DBW188_BIT15: 'DB1001,X189.7' // 备用
};
